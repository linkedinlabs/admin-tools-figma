...
1. Unzip the `AdminTool.figmaplugin.zip` file somewhere on your computer where you will be able to find it later.
...
1. Unzip the `AdminTool.figmaplugin.zip` file.
